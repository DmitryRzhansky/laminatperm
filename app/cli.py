...
CATEGORIES = [
    {
        ...
        "cover": "images/catalog/laminate.webp",
    },
    {
        "name": "Линолеум",
        "slug": "linoleum",
        ...
        "cover": "images/catalog/linoleum.webp",
    },
    {
        "name": "SPC",
        "slug": "spc",
    ...
    },
    {
        ...
        "cover": "images/catalog/accessories.webp",
    },
    {
        "name": "Клеевой LVT",
        "slug": "kleevoy-lvt",
...
def _seed_categories():
    for index, data in enumerate(CATEGORIES, start=1):
        if ProductCategory.query.filter_by(slug=data["slug"]).first():
            continue
        db.session.add(
            ProductCategory(
                name=data["name"],
